...
const UserDetails = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      // Only send the form fields to the API
      const formFields = {
        ...
        fieldOfStudy: editedUser.fieldOfStudy,
        levelOfStudy: editedUser.levelOfStudy,
        // role: editedUser.role,
        isEmailVerified: editedUser.isEmailVerified,
        accountClosed: editedUser.accountClosed,
        description: editedUser.description
      };

      console.log('Saving user data:', formFields);
      await axiosInstance.patch(`/users/${userId}`, formFields);
      ...
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <Box sx={{ display: 'flex', gap: 2, mb: 3 }}>
            ...
            <Button variant="outlined" color="info" startIcon={<IconEye />} onClick={() => navigate(`/users/profile/${userId}`)}>
              Voir le profil
            </Button>
            <Button
          ...
          <Card>
            <CardContent sx={{ textAlign: 'center' }}>
              {editing ? (
                ...
                <Avatar src={user.avatar} alt={`${user.firstname} ${user.lastname}`} sx={{ width: 120, height: 120, mx: 'auto', mb: 2 }} />
              )}
              ...
              <CardContent>
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Prénom" name="firstname" value={editedUser.firstname || ''} onChange={handleInputChange} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Nom" name="lastname" value={editedUser.lastname || ''} onChange={handleInputChange} />
                  </Grid>
                  <Grid item xs={12}>
                    <TextField fullWidth label="Email" name="email" value={editedUser.email || ''} onChange={handleInputChange} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Ville" name="city" value={editedUser.city || ''} onChange={handleInputChange} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="École" name="school" value={editedUser.school || ''} onChange={handleInputChange} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField
                      fullWidth
